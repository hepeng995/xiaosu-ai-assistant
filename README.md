...
| 管理后台概览 | 运营数据面板 |
|---|---|
| 文档管理 / 对话日志 / 系统设置 / 调试聊天 | Token 消耗 / 工具调用统计 / 成本估算 |

> 截图未纳入仓库（已加入 `.gitignore`）。本地启动后访问 `http://localhost:3001/admin` 可查看真实后台界面。
...
| 分类 | 关键变量 | 说明 |
|---|---|---|
| 应用 | `APP_ENV`、`APP_PORT`、`WEB_BASE_URL` | 应用环境、API 端口、后台访问地址 |
...
- [招聘笔试题.html](./招聘笔试题.html)
- [开发规范.md](./开发规范.md)
- [AI 助手开发文档.md](./AI%20助手开发文档.md)
- [小苏 AI 助手分阶段开发文档.md](./小苏%20AI%20助手分阶段开发文档.md)
- [AI_USAGE.md](./AI_USAGE.md)
- [自评.md](./自评.md)
- [docs/增强项开发计划.md](./docs/%E5%A2%9E%E5%BC%BA%E9%A1%B9%E5%BC%80%E5%8F%91%E8%AE%A1%E5%88%92.md)
- [docs/web-app-readme.md](./docs/web-app-readme.md)
